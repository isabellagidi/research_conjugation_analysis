...
def activation_patching(
    ...
    try:
        ...
        for label, clean_txts, corrupt_txts, answers in [
            (f"{tag_b}2{tag_a}", texts_2[:max_prompts_head], texts_1[:max_prompts_head], a2[:max_prompts_head]),
            (f"{tag_a}2{tag_b}", texts_1[:max_prompts_head], texts_2[:max_prompts_head], a1[:max_prompts_head]),
        ]:
            run_attn_head_out_patching(
...
#]:
#for iso3 in ["cat", "ces", "deu", "fin", "swe"]:

#for iso3 in ["fra", "hun", "ita", "mon", "rus"]:

#for iso3 in ["eng","spa","por"]:
for iso3 in ["fra", "hun", "ita", "mon", "rus"]:
