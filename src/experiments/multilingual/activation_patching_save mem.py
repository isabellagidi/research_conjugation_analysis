# need to edit this such that output is readible
...
def activation_patching(
    *,                       # keyword‑only for clarity
    ...
    model_name,            # <- already‑loaded model
    tl_model,
    ...
    try:
        ...
        device = tl_model.cfg.device     # just after the function header
...
#]:
for iso3 in ["ces","deu","mon","rus","spa","swe"]:
