...
results_dla_first_sing_spanish = compute_direct_logit_attribution(
    model=model,
    tokenizer=tokenizer,
    prompt_texts=correct_prompt_texts_first_sing_spanish,     # decoded prompts
    answer_ids=correct_answers_ids_first_sing_spanish,        # gold token IDs
    label="Format YO"
)
...
results_dla_second_sing_spanish = compute_direct_logit_attribution(
    model=model,
    tokenizer=tokenizer,
    prompt_texts=correct_prompt_texts_second_sing_spanish,     # decoded prompts
    answer_ids=correct_answers_ids_second_sing_spanish,        # gold token IDs
    label="Format TU"
)
...
logit_lens_results_first_sing_spanish = compute_logit_lens(
    ...
    gold_token_ids=correct_answers_ids_first_sing_spanish
)
...
logit_lens_results_second_sing_spanish = compute_logit_lens(
    ...
    gold_token_ids=correct_answers_ids_second_sing_spanish
)
...
logit_lens_results_examples_first_sing_spanish = compute_logit_lens(
    model=model,
    tokenizer=tokenizer,
    prompts=correct_prompt_texts_first_sing_spanish[:3],
    gold_token_ids=correct_answers_ids_first_sing_spanish[:3]
)

logit_lens_results_examples_second_sing_spanish = compute_logit_lens(
    model=model,
    tokenizer=tokenizer,
    prompts=correct_prompt_texts_second_sing_spanish[:3],
    gold_token_ids=correct_answers_ids_second_sing_spanish[:3]
)
# Plot both YO and TU
...
plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_first_sing_spanish[0], save_path="logit_lens_heatmap_first_sing_spanish0.png")
plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_second_sing_spanish[0], save_path="logit_lens_heatmap_second_sing_spanish0.png")

plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_first_sing_spanish[1], save_path="logit_lens_heatmap_first_sing_spanish1.png")
plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_second_sing_spanish[1], save_path="logit_lens_heatmap_second_sing_spanish1.png")

#plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_first_sing_spanish[2], save_path="logit_lens_heatmap_first_sing_spanish2.png")
#plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_second_sing_spanish[2], save_path="logit_lens_heatmap_second_sing_spanish2.png")

#plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_first_sing_spanish[3], save_path="logit_lens_heatmap_first_sing_spanish3.png")
#plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_second_sing_spanish[3], save_path="logit_lens_heatmap_second_sing_spanish3.png")

#plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_first_sing_spanish[4], save_path="logit_lens_heatmap_first_sing_spanish4.png")
#plot_logit_lens_heatmap(model, tokenizer, correct_prompt_texts_second_sing_spanish[4], save_path="logit_lens_heatmap_second_sing_spanish4.png")


#EXAMPLE LAYERWISE LOGIT ATTRIBUTION
#compute_layerwise_gold_logit_contributions(model, tokenizer, prompt=correct_prompt_texts_first_sing_spanish[0], gold_token_id=correct_answers_ids_first_sing_spanish[0], save_path="layerwise_gold_logit_first_sing_spanish0.png")
#compute_layerwise_gold_logit_contributions(model, tokenizer, prompt=correct_prompt_texts_first_sing_spanish[1], gold_token_id=correct_answers_ids_first_sing_spanish[1], save_path="layerwise_gold_logit_first_sing_spanish1.png")
#compute_layerwise_gold_logit_contributions(model, tokenizer, prompt=correct_prompt_texts_first_sing_spanish[2], gold_token_id=correct_answers_ids_first_sing_spanish[2], save_path="layerwise_gold_logit_first_sing_spanish2.png")


#compute_layerwise_gold_logit_contributions(model, tokenizer, prompt=correct_prompt_texts_second_sing_spanish[0], gold_token_id=correct_answers_ids_second_sing_spanish[0], save_path="layerwise_gold_logit_second_sing_spanish0.png")
#compute_layerwise_gold_logit_contributions(model, tokenizer, prompt=correct_prompt_texts_second_sing_spanish[1], gold_token_id=correct_answers_ids_second_sing_spanish[1], save_path="layerwise_gold_logit_second_sing_spanish1.png")
#compute_layerwise_gold_logit_contributions(model, tokenizer, prompt=correct_prompt_texts_second_sing_spanish[2], gold_token_id=correct_answers_ids_second_sing_spanish[2], save_path="layerwise_gold_logit_second_sing_spanish2.png")


#AVERAGE LAYERWISE LOGIT ATTRIBUTION

compute_average_layerwise_gold_logit_contributions(model, tokenizer, prompts=correct_prompt_texts_first_sing_spanish, gold_token_ids=correct_answers_ids_first_sing_spanish, save_path="avg_layerwise_gold_logit_first_sing_spanish.png", label = "FIRST SING")

compute_average_layerwise_gold_logit_contributions(model, tokenizer, prompts=correct_prompt_texts_second_sing_spanish, gold_token_ids=correct_answers_ids_second_sing_spanish, save_path="avg_layerwise_gold_logit_second_sing_spanish.png", label="SECOND SING")
