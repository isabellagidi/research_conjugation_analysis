...
TEMPLATES: Dict[str, Tuple[str, Dict[str, str]]] = {
    "catalan": (
        "Conjugació de {verb}: {pronoun} {conj}",
        {
            "first singular": "Jo",
            "second singular": "Tu",
            "third singular": "Ell",
    ...
    "spanish": (
        "Conjugación de {verb}: {pronoun} {conj}",
        {
            "first singular": "Yo",
            "second singular": "Tú",
            "third singular": "Él",
    ...
    "french": (
        "Conjugaison de {verb} : {pronoun} {conj}",
        {
            "first singular": "Je",
            "second singular": "Tu",
            "third singular": "Il",
    ...
    "portuguese": (
        "Conjugação de {verb}: {pronoun} {conj}",
        {
            "first singular": "Eu",
            "second singular": "Tu",
            "third singular": "Ele",
    ...
    "german": (
        "Konjugation von {verb}: {pronoun} {conj}",
        {
            "first singular": "Ich",
            "second singular": "Du",
            "third singular": "Er",
    ...
    "english": (
        "Conjugation of {verb}: {pronoun} {conj}",
        {
            "first singular": "I",
            "second singular": "You",
            "third singular": "He",
    ...
    "italian": (
        "Coniugazione di {verb}: {pronoun} {conj}",
        {
            "first singular": "Io",
            "second singular": "Tu",
            "third singular": "Lui",
